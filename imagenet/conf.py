...
# Number of continual passes over the severity x corruption stream. The model is
# reset only before the first domain of the first round.
_C.CORRUPTION.ROUNDS = 1
...
# Ours parameters. Only the two Ours up-projections
# are optimized; the source backbone uses OPTIM.LR (0 in the released configs).
_C.OPTIM.OursLR = 2e-4
_C.TEST.ours_rank = 32
_C.OPTIM.Ours_slora_gamma = 0.5
_C.OPTIM.Ours_plora_gamma = 1.0
_C.OPTIM.Ours_merge_gamma = 3.0
_C.OPTIM.Ours_lora_eps = 1e-5
_C.OPTIM.Ours_use_slora = True
_C.OPTIM.Ours_use_plora = True
_C.OPTIM.Ours_avg = False

# Confidence-filtered sharpness-aware online update.
_C.OPTIM.Ours_use_gao = False
_C.OPTIM.Ours_GAO_conf_thr = 0.7
_C.OPTIM.Ours_GAO_rho = 0.3
_C.OPTIM.Ours_GAO_min_samples = 2
_C.OPTIM.Ours_gao_update = "within_batch_symmetric"

# Boundary-free covariance-fingerprint detector.
_C.OPTIM.Ours_switch_thr = 0.254
_C.OPTIM.Ours_switch_gap = 6
_C.OPTIM.Ours_switch_metric = "frobenius"
_C.OPTIM.Ours_proto_ema = 0.2
_C.TEST.ours_switch_layers = [9, 10, 11]
_C.TEST.ours_switch_subspace_r = 64

# Controls retained for reproducible ablations; the released method uses False/full.
_C.OPTIM.Ours_switch_oracle = False
_C.OPTIM.Ours_renew_mode = "full"

# Energy threshold used to project the private entropy-gradient subspace away
# from the historical input subspace.
_C.OPTIM.Ours_history_proj_thr = 0.99
